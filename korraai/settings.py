"""
Django settings for korraai project.
...
SECRET_KEY = 'django-insecure-^^tfm3wc@zvz@384h^tgv@3mlu$oa%%kzm7ge41aas7k4$$p6)'
...
# Keep your existing AUTH_USER_MODEL
...
WSGI_APPLICATION = 'korraai.wsgi.application'
